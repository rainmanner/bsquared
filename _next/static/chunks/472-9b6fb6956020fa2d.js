    ...
    [472], {
        ...
        28146: function(e, t, r) {
            ...
            async function f(e, t, r, f, d) {
                ...
                try {
                    let t = new URL(e);
                    t.pathname.endsWith("/") ? t.pathname += "index.txt" : t.pathname += ".txt", t.searchParams.set(n.NEXT_RSC_UNION_QUERY, _);
                    let r = await fetch(t, {
                    ...
                    if (y || (y = d.startsWith("text/plain")), !y || !r.ok) return e.hash && (a.hash = e.hash), c(a.toString());
